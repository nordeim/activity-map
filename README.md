...
| 👤 **Profile** | Session-12 redesign into TWO glass cards (896px): the identity card (rounded-36, bg-white/78, border-white/70) with the Profile eyebrow, the account identity as the h1 (session-14: the live now shows the USERNAME "sepnetflix2023" — 72px serif) with the EMAIL as the 16px #555550 line ("Your Roam account" is gone), the cream outlined Augsburg / 0-day-streak / Explorer chips, and the dark heart Saved-places button into /favourites; the bookings card (rounded-32, mt-8) with the 36px "My bookings" h2, FULL-WIDTH 44px/12px Upcoming/Past tabs, 38px All/Eat/Stay/Do filters, and the white rounded-26 empty state; a Back-to-home control + Sign out top row |
